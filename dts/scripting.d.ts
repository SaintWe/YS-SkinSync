...
type ListViewProps = {
     ...
     * @available iOS 26.0+.
     */
    listSectionMargins?: number | EdgeInsets | {
        edges: EdgeInsets;
        length: number;
    };
    /**
